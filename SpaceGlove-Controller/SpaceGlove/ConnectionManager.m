...
-(id)init{
    ...
    if (self) {
        ...
        NSString *dID = @"naveed";
        [self setupPeerAndSessionWithDisplayName:dID];
        _browser = nil;
        _advertiser = nil;
...
- (void)startBrowsingWithDelegate:(id)delegate {
    ...
    [(UIViewController *)delegate presentViewController:_browser animated:YES completion:^{
        
    }];
}


- (void)connectToPeerS:(id)delegate {
